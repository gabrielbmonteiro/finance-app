...
import com.narrapay.domain.usecase.TransacaoPluggyDto
import com.narrapay.util.NotificationParser
...
class TransacaoNotificationService : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        ...
        Log.d("Narrapay", "Notificação interceptada do pacote: $packageName")
        ...
        Log.d("Narrapay", "Título: $title | Texto: $text")
        ...
        if (parsedData != null) {
            ...
            serviceScope.launch {
                try {
                    ...
                    Log.d("Narrapay", "Sucesso! Compra no '${dto.description}' salva.")
                } catch (e: Exception) {
                    Log.e("Narrapay", "Erro ao processar a notificação no UseCase", e)
                }
            }
        }
    }
