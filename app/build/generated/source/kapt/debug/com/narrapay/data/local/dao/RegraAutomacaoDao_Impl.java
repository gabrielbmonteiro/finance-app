...
public final class RegraAutomacaoDao_Impl implements RegraAutomacaoDao {
  ...
  @Override
  public Object insert(final RegraAutomacaoEntity regra, final Continuation<? super Long> arg1) {
  ...
  @Override
  public Object delete(final RegraAutomacaoEntity regra, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object update(final RegraAutomacaoEntity regra, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
