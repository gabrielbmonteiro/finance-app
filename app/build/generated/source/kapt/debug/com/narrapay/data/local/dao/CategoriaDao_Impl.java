...
public final class CategoriaDao_Impl implements CategoriaDao {
  ...
  @Override
  public Object insert(final CategoriaEntity categoria, final Continuation<? super Long> arg1) {
  ...
  @Override
  public Object delete(final CategoriaEntity categoria, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object update(final CategoriaEntity categoria, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
