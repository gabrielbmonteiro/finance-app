...
public final class PessoaDao_Impl implements PessoaDao {
  ...
  @Override
  public Object insert(final PessoaEntity pessoa, final Continuation<? super Long> $completion) {
  ...
  @Override
  public Object delete(final PessoaEntity pessoa, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object update(final PessoaEntity pessoa, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
